...
import salt.ext.monitor.cron

class TestTime(unittest.TestCase):

    def setUp(self):
        self.cron = salt.ext.monitor.cron.CronParser()

    def _test_interval(self, intime, expected):
        actual = salt.ext.monitor.cron.parse_interval(intime)
    ...
    def test_doc(self):
        doctest.testmod(salt.ext.monitor.cron)
